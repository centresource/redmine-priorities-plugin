# Hooks to attach to the Redmine Priorities List in the issue view.

class PriorityIssuesHook < Redmine::Hook::ViewListener
  ...
  def view_layouts_base_html_head(context = {})
    ...
    if (controller.class.name == 'ProjectsController' and action_name == 'activity')
      o = ""
      o << stylesheet_link_tag('priorities', :plugin => 'redmine_priorities_plugin')
      return o
    end
  end
end
